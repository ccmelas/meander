...
// GoogleGeometryAlias is Exported googleGeometry
type GoogleGeometryAlias googleGeometry

// Place represents a place recommendation
type Place struct {
	*GoogleGeometryAlias `json:"geometry"`
...
// GoogleLocation houses lat/lng pair
...
// Public makes Place implement the Facade interface
